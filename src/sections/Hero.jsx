      ...
      <Element name="hero">
        <div className="container">
          <div className="relative z-2 max-w-512 max-lg:max-w-388">
            ...
            <h1 className="h1 max-lg:h2 mb-6 uppercase text-p4 max-lg:mb-7 max-md:text-5xl max-md:leading-12">
              Amazingly simple
            </h1>
          ...
          <div className="poi hero-img_res pointer-events-none absolute -top-32 left-[calc(50%-340px)] w-[1230px]">
            <img
              src="/images/hero.png"
              alt="hero"
